...
parser.add_argument("--action", choices=["del", "adm", "low", "ban", "unban"],
                    help="Аргумент del удалит пользователя, аргумент adm даст пользователю статус администратора, аргумент low отнимет привелегию у пользователя, аргумент ban забанит пользователя, арумент unban разбанит пользователя")
